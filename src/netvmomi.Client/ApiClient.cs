...
namespace netvmomi.Client {
    ...
    public class ApiClient {
        ...
        public ApiClient(string basePath = "http://example.com/rest") {
            BasePath = basePath;
        ...
        public object CallApi(string path, Method method, Dictionary<string, string> queryParams, string postBody,
            ...
            foreach (KeyValuePair<string, string> defaultHeader in _defaultHeaderMap) {
            ...
            if (postBody != null) // http body (model) parameter
{
        ...
        public string GetApiKeyWithPrefix(string apiKeyIdentifier) {
            Configuration.ApiKey.TryGetValue(apiKeyIdentifier, out string apiKeyValue);
            if (Configuration.ApiKeyPrefix.TryGetValue(apiKeyIdentifier, out string apiKeyPrefix)) {
